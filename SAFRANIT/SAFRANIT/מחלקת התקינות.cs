...
{ 
    ...
    public class EmailRule2 : ValidationRule
    {
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (match.Success)
                ...
                return new ValidationResult(false,
                          "בבקשה הכנס מייל תקין");  // is incorrect
        }
    }
    public class isHebrewRule2 : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (match.Success)
                ...
                return new ValidationResult(false,
                          "בבקשה הקלד בעברית");  // is incorrect
        }
    }
        ...
        : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (match.Success)
                ...
                return new ValidationResult(false,
                          "בבקשה הקלד מספר טלפון תקין");  // is incorrect
        }
    }
    ...
    public class IsNumber : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (match.Success)
                ...
                return new ValidationResult(false,
                          "בבקשה הכנס מספר חוקי");  // is incorrect
        }
    }
    ...
    public class IsId : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (sum % 10 != 0) return new ValidationResult(false, "התעודת זהות שגויה");
            return ValidationResult.ValidResult;  // correct
